...
const ThirdPanel = () => {
  const [activeStep, setActiveStep] = useState(3); // "Location" step is active.
      ...
      <div className="w-3/4 flex flex-col items-center justify-center p-10">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8 flex  flex-col items-center justify-center">
            <h2  className='text-4xl font-[500] ' ><i class="ri-map-2-line"></i></h2>
            <h1 className="text-3xl font-bold text-gray-800">Location</h1>
            <p className="text-gray-500">Please provide your location</p>
          </div>
